...
// Without the file the release build falls back to debug keys, so `flutter run
// --release` still works on a machine that has no business signing a release.
...
android {
    namespace = "app.uniride.uniride_app"
    ...
    defaultConfig {
        // This is the identity of the existing Play listing, carried over from v1.
        // An upload under any other id is a different app, not an update.
        applicationId = "com.asterisks.uniride"
